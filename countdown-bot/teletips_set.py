...
bot=Client(
    "Countdown-TeLeTiPs",
    api_id = 17747559,
    api_hash = "e7dc68334f25e4c601aca38c32e28d17",
    bot_token = "5241580012:AAH3ytgDdIZkpVIwIJWZeEf_MG3hrvtyX3k"
)
        ...
        if message.chat.id>0:
            ...
            if 0<user_input_time<=10:
                while user_input_time and not stoptimer:
                    ...
                    Countdown_TeLe_TiPs='{}\n\n⏳ {:02d}**s**\n\n<i>Saints Commissioning and InGathering Activation'.format(user_input_event, s)
                ...
                while user_input_time>0 and not stoptimer:
                    ...
                    s=user_input_time%60
                    Countdown_TeLe_TiPs='{}\n\n⏳ {:02d}**m** : {:02d}**s**\n\n<i>Saints Commissioning and InGathering Activation'.format(user_input_event, m, s)
                    finish_countdown = await get_user_input_time.edit(Countdown_TeLe_TiPs)
                    await asyncio.sleep(3)
                    user_input_time -=3
                await finish_countdown.edit("🚨 Beep! Beep!! **TIME'S UP!!!**")
                ...
                while user_input_time>0 and not stoptimer:
                    ...
                    m=user_input_time%3600//60
                    s=user_input_time%60
                    Countdown_TeLe_TiPs='{}\n\n⏳ {:02d}**h** : {:02d}**m** : {:02d}**s**\n\n<i>Saints Commissioning and InGathering Activation'.format(user_input_event, h, m, s)
                    finish_countdown = await get_user_input_time.edit(Countdown_TeLe_TiPs)
                ...
                while user_input_time>0 and not stoptimer:
                    ...
                    m=user_input_time%3600//60
                    s=user_input_time%60
                    Countdown_TeLe_TiPs='{}\n\n⏳ {:02d}**d** : {:02d}**h** : {:02d}**m** : {:02d}**s**\n\n<i>Saints Commissioning and InGathering Activation'.format(user_input_event, d, h, m, s)
                    finish_countdown = await get_user_input_time.edit(Countdown_TeLe_TiPs)
